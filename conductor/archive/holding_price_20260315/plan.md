...
- [x] Task: Conductor - User Manual Verification 'Phase 1: Config + Database' (Protocol in workflow.md)

## Phase 2: Holding Price Summary Logic + Template
<!-- execution: parallel -->

- [x] Task 1: Add `build_holding_summary` to `emailer.py`
...
- [x] Task 2: Update `email_success.html` template
...
- [x] Task 3: Unit tests for `build_holding_summary` and template rendering
...
- [x] Task: Conductor - User Manual Verification 'Phase 2: Holding Price Summary Logic + Template' (Protocol in workflow.md)

## Phase 3: Wire Into `__main__.py`

- [x] Task 1: Update `__main__.py` and `emailer.py`
